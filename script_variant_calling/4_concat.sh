...
# Note : Chunk were ordered by chromosome and position in all.vcf.freebayes.list, pool.vcf.freebayes.list and ind.vcf.freebayes.list. This concatenation script in only for autosomes VCF.
