# Script for generate reference table of old_div scenario
...
for (seed in k:j) {
	...
	run.simu_old_div<-function(Ne_ancpp,Ne_sp_ancfound,Ne_wp_ancfound,Ne_fu_found,Ne_wp_found,Ne_sp_anc,Ne_wp_anc,
    ...
    # First run simulaton for have count data
	  G=simu_WP_FU_A(Ne_ancpp=Ne_ancpp,Ne_fu=Ne_fu,Ne_wp=Ne_wp,Ne_sp=Ne_sp,Ne_fu_found=Ne_fu_found,Ne_wp_found=Ne_wp_found,Ne_sp_ancfound=Ne_sp_ancfound,Ne_sp_anc=Ne_sp_anc,Ne_wp_anc=Ne_wp_anc,
    ...
    # Simulate individual data for estimate summary statistics on simulate individual data
	  simu_old_div_ind(Ne_ancpp=Ne_ancpp,Ne_fu=Ne_fu,Ne_wp=Ne_wp,Ne_sp=Ne_sp,Ne_fu_found=Ne_fu_found,Ne_wp_found=Ne_wp_found,Ne_sp_ancfound=Ne_sp_ancfound,Ne_sp_anc=Ne_sp_anc,Ne_wp_anc=Ne_wp_anc,
                       Ne_bot_sp=Ne_bot_sp,Ne_bot_wp=Ne_bot_wp,Ne_bot_fu=Ne_bot_fu,Ne_wp_ancfound=Ne_wp_ancfound,m_spfu_rec=m_spfu_rec,m_wpfu_rec=m_wpfu_rec,m_ancpp=m_ancpp,
                       tsplit_PP=tsplit_PP,tsplit_WP=tsplit_WP,t_bot=t_bot,m_spwp_anc=m_spwp_anc,m_spwp_rec=m_spwp_rec,m_spfu_anc=m_spfu_anc,m_wpfu_anc=m_wpfu_anc,
    ...
    H<-simu_old_div_Uhl(Ne_ancpp=Ne_ancpp,Ne_fu=Ne_fu,Ne_wp=Ne_wp,Ne_sp=Ne_sp,Ne_fu_found=Ne_fu_found,Ne_wp_found=Ne_wp_found,Ne_sp_ancfound=Ne_sp_ancfound,Ne_sp_anc=Ne_sp_anc,Ne_wp_anc=Ne_wp_anc,
                       Ne_bot_sp=Ne_bot_sp,Ne_bot_wp=Ne_bot_wp,Ne_bot_fu=Ne_bot_fu,Ne_wp_ancfound=Ne_wp_ancfound,m_spfu_rec=m_spfu_rec,m_wpfu_rec=m_wpfu_rec,m_ancpp=m_ancpp,
                       tsplit_PP=tsplit_PP,tsplit_WP=tsplit_WP,t_bot=t_bot,m_spwp_anc=m_spwp_anc,m_spwp_rec=m_spwp_rec,m_spfu_anc=m_spfu_anc,m_wpfu_anc=m_wpfu_anc,
  ...
  # Creation of reference table for this simulation
	file.name=paste0("reftable.old_div.",seed)
	SP_classes <- paste("SPclasse", 0:50, sep = "")
	WP_classes <- paste("WPclasse", 0:36, sep = "")
	FU_classes <- paste("FUclasse", 0:20, sep = "")
	  
	cat(file=file.name,c(
	  "sim.Ne_ancpp","sim.Ne_sp","sim.Ne_wp","sim.Ne_fu","sim.Ne_fu_found","sim.Ne_wp_found","sim.Ne_sp_ancfound","sim.Ne_wp_ancfound","sim.Ne_sp_anc","sim.Ne_wp_anc","sim.Ne_bot_sp",
  ...
  # Run the simulation
	for(i in 1:nsample){
	  simu=run.simu_old_div(Ne_ancpp=Ne_ancpp[i],Ne_fu=Ne_fu[i],Ne_wp=Ne_wp[i],Ne_sp=Ne_sp[i],Ne_fu_found=Ne_fu_found[i],Ne_wp_found=Ne_wp_found[i],Ne_sp_ancfound=Ne_sp_ancfound[i],
      		  Ne_wp_ancfound=Ne_wp_ancfound[i],Ne_sp_anc=Ne_sp_anc[i],Ne_wp_anc=Ne_wp_anc[i],tsplit_PP=tsplit_PP[i],tsplit_WP=tsplit_WP[i],t_bot=t_bot[i],m_ancpp=m_ancpp[i],
	  ...
	  simu.par=c(Ne_ancpp[i],Ne_sp[i],Ne_wp[i],Ne_fu[i],Ne_fu_found[i],Ne_wp_found[i],Ne_sp_ancfound[i],Ne_wp_ancfound[i],Ne_sp_anc[i],Ne_wp_anc[i],Ne_bot_sp[i],
