...
#SBATCH --ntasks 1
#SBATCH --mem=32G
# Script to run RZooROH analyses. 
# This code is launch with 5_launcher_RZooRoH_analyse.sh.
# Note: This code was run on genobioinfo cluster for run in parallel for each population
